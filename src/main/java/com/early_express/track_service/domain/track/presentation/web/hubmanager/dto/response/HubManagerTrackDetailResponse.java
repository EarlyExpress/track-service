package com.early_express.track_service.domain.track.presentation.web.hubmanager.dto.response;
...
/**
 * Track 상세 응답 DTO (Hub Manager)
 * - 허브 관리에 필요한 정보 포함
 */
@Getter
@Builder
public class HubManagerTrackDetailResponse {
     ...
     */
    public static HubManagerTrackDetailResponse from(TrackDetailResponse queryResult) {
        TrackResponse track = queryResult.getTrack();

        return HubManagerTrackDetailResponse.builder()
